...
namespace TradingService.Functions.TradeManagement
{
    public class GetComparisonData
    {
        ...
        public GetComparisonData(IConfiguration configuration, ISymbolItemRepository symbolRepo, IBlockItemRepository blockRepo, ITradeService tradeService, IAccountItemRepository accountRepo)
        {
            ...
            ILogger log)
        {
            ...
            // Get open orders
            var openOrders = await _tradeService.GetOpenOrders(_configuration, userId);
